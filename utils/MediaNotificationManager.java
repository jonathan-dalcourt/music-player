...
import com.dalcourt.jonathan.musicplayer.utils.AlbumArtCache;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public MediaNotificationManager(BackgroundAudioService service, Context context) {
        mService = service;
...
//            mController = new MediaController(mService, mSessionToken);
    ...
    private Notification createNotification() {
        ...
        if ((mPlaybackState.getActions() & PlaybackState.ACTION_SKIP_TO_PREVIOUS) != 0) {
            builder.addAction(R.drawable.restart,
        ...
        if ((mPlaybackState.getActions() & PlaybackState.ACTION_SKIP_TO_NEXT) != 0) {
            builder.addAction(R.drawable.skip,
        ...
        if (description.getIconUri() != null) {
            ...
            if (art == null) {
                ...
                art = BitmapFactory.decodeResource(
                        mService.getResources(), R.drawable.missing_cover);
            }
        }
        builder
    ...
    private void fetchBitmapFromURLAsync(
            final String bitmapUrl, final NotificationCompat.Builder builder) {
